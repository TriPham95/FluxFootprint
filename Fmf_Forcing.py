...
Start = FmfData.index.get_loc((FmfData[FmfData['TIMESTAMP_START'] == 200901010000]).iloc[0].name)
End = FmfData.index.get_loc((FmfData[FmfData['TIMESTAMP_START'] == 200912312300]).iloc[0].name)
FmfDF = FmfData[Start:End]
...
FmfData['P'].plot(ax=ax6,label = "Precipitation", color = 'black')
...
FmfData['SW_IN'][Start:End].plot(ax=ax1, label = "Shortwave Radiation", color = 'black')
...
FmfData['TA'][Start:End].plot(ax=ax2, label = "Air Temperature", color = 'black')
...
FmfData['WS'][Start:End].plot(ax=ax3, label = "Wind Speed", color = 'black')
...
(FmfData['PA']*10)[Start:End].plot(ax=ax4, label = "Air Pressure", color = 'black')
...
FmfData['RH'][Start:End].plot(ax=ax5, label = "Relative Humidity", color = 'black')
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures/Fmf_Forcing_2009_v2.png", 
