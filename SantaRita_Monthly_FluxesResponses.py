...
###
SrcDF.groupby(['month']).mean()['NETRAD'].plot(ax=ax1, linewidth = 4, color = 'green')
SrgDF.groupby(['month']).mean()['NETRAD'].plot(ax=ax1, linewidth = 4, color = 'red')
SrmDF.groupby(['month']).mean()['NETRAD'].plot(ax=ax1, linewidth = 4, color = 'blue')
...
SrcDF.groupby(['month']).mean()['LE_F_MDS'].plot(ax=ax2, linewidth = 4, color = 'green')
SrgDF.groupby(['month']).mean()['LE_F_MDS'].plot(ax=ax2, linewidth = 4, color = 'red')
SrmDF.groupby(['month']).mean()['LE_F_MDS'].plot(ax=ax2, linewidth = 4, color = 'blue')
...
SrcDF.groupby(['month']).mean()['H_F_MDS'].plot(ax=ax3, linewidth = 4, color = 'green')
SrgDF.groupby(['month']).mean()['H_F_MDS'].plot(ax=ax3, linewidth = 4, color = 'red')
SrmDF.groupby(['month']).mean()['H_F_MDS'].plot(ax=ax3, linewidth = 4, color = 'blue')
...
SrcDF.groupby(['month']).mean()['G_F_MDS'].plot(ax=ax4, linewidth = 4, color = 'green')
SrgDF.groupby(['month']).mean()['G_F_MDS'].plot(ax=ax4, linewidth = 4, color = 'red')
SrmDF.groupby(['month']).mean()['G_F_MDS'].plot(ax=ax4, linewidth = 4, color = 'blue')
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/SantaRita_Monthly_SurfaceFluxes.pdf", 
