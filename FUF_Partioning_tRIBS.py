...
barWidth = 1
bars = np.add(FufParition['Soil Evaporation'], FufParition['Transpiration']).tolist()
...
lns2 = ax1.bar(FufParition.index, FufParition['Soil Evaporation'], label = 'Soil Evaporation [mm/month]',
               color='orange', width=barWidth, edgecolor = 'black',align = 'center')
lns3 = ax1.bar(FufParition.index, FufParition['Transpiration'], 
               bottom=FufParition['Soil Evaporation'],  label = 'Transpiration [mm/month]',
               color='green', width=barWidth, edgecolor = 'black', align = 'center')
lns4 = ax1.bar(FufParition.index, FufParition['Wet Canopy Evaporation'], 
               bottom=bars, color='blue',  label = 'Wet Canopy Evaporation [mm/month]',
               width=barWidth, edgecolor = 'black', align = 'center')

lns1 = ax2.bar(FufParition.index, FufParition['P_F'], edgecolor = 'black', 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FufPartition_2010_v2.pdf", 
