...
Start = FufDF.index.get_loc((FufDF[FufDF.index == '2007-06-01 00:00:00']).iloc[0].name)
End = FufDF.index.get_loc((FufDF[FufDF.index == '2007-09-01 00:00:00']).iloc[0].name)


FufDF = FufDF[Start:(End+1)]


FufParition = FufDF[['Transpiration', 'EvaporationCanopy',
...
lns2 = ax1.plot(FufParition.index, FufParition['Soil Evaporation'], 
               label = 'Soil Evaporation [mm/hr]', color='orange', linewidth = 4)
lns3 = ax1.plot(FufParition.index, FufParition['Transpiration'],  
               label = 'Transpiration [mm/hr]', color='green', linewidth = 4)
lns4 = ax1.plot(FufParition.index, FufParition['Wet Canopy Evaporation'], 
               color='blue',  label = 'Wet Canopy Evaporation [mm/hr]', linewidth = 4)

lns1 = ax2.bar(FufParition.index, FufParition['P_sum'], edgecolor = 'black', 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FufPartition_Hourly_2010_v2.pdf", 
