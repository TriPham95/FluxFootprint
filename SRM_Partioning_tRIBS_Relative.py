...
SrmParition['ET'] = SrmParition['Transpiration'] + SrmParition['Wet Canopy Evaporation'] + SrmParition['Soil Evaporation']


SrmParition['SE/ET'] = SrmParition['Soil Evaporation'] / SrmParition['ET']
SrmParition['WCE/ET'] = SrmParition['Wet Canopy Evaporation'] / SrmParition['ET']
SrmParition['T/ET'] = SrmParition['Transpiration'] / SrmParition['ET']



barWidth = 1
bars = np.add(SrmParition['SE/ET'], SrmParition['T/ET']).tolist()
...
lns2 = ax1.bar(SrmParition.index, SrmParition['SE/ET'], label = 'Esoil/ET',
               color='orange', width=barWidth, edgecolor = 'black',align = 'center')
lns3 = ax1.bar(SrmParition.index, SrmParition['T/ET'], 
               bottom=SrmParition['SE/ET'],  label = 'T/ET',
               color='green', width=barWidth, edgecolor = 'black', align = 'center')
lns4 = ax1.bar(SrmParition.index, SrmParition['WCE/ET'], 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/SrmPartition_Relative_2010_v2.pdf", 
