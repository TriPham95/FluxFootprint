...
FufFile = '/home/tpham/Desktop/ProcessedFiles/FufDiurnal_validation_v3.csv'
...
Start = np.where(FufData["Date"] == str('06/01/2007 00:00'))[0][0]
End = np.where(FufData["Date"] == str('08/01/2007 01:00'))[0][0]
...
FufData['Rain_Obs'].plot(ax=ax6, linewidth = 2, color = 'black')
ax6.set_ylabel("P [mm]", fontsize = 22, fontweight = 'bold')
ax6.minorticks_off()
ax6.get_xaxis().set_visible(False)


FufData['NetRad_Sim'][Start:End].plot(ax=ax4, color = 'red', linewidth = 2)
FufData['NetRad_Obs'][Start:End].plot(ax=ax4, color = 'black', linewidth = 2)
...
FufData['LE_Sim'][Start:End].plot(ax=ax1, color = 'red', linewidth = 2)
FufData['LE_Obs'][Start:End].plot(ax=ax1, color = 'black', linewidth = 2)
...
FufData['H_Sim'][Start:End].plot(ax=ax2, color = 'red', linewidth = 2)
FufData['H_Obs'][Start:End].plot(ax=ax2, color = 'black', linewidth = 2)
...
FufData['G_Sim'][Start:End].plot(ax=ax3, color = 'red', linewidth = 2)
FufData['G_Obs'][Start:End].plot(ax=ax3, color = 'black', linewidth = 2)
...
ax5.plot(mdates.date2num(list(FufData.index[Start:End])), FufData['TS_Sim'][Start:End], color = 'red', linewidth = 2)
ax5.plot(mdates.date2num(list(FufData.index[Start:End])), FufData['TS_Obs'][Start:End], color = 'black', linewidth = 2)
...
ax5.legend(labels = line_labels, bbox_to_anchor=(0.75, -0.35), ncol = 2, frameon=False, fontsize = 22)

plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FufDiurnal_2007_v3.pdf", 
...
lns1 = ax1.plot(mdates.date2num(list(FufData.index)), FufData['SoilMoisture_Sim'],
         label = 'Simulated 10-cm SWC', linewidth = 4, color = 'red')

lns2 = ax1.plot(mdates.date2num(list(FufData.index)), FufData['SoilMoisture_Obs'],
         label = 'Observed 10-cm SWC', linewidth = 4, color = 'black')
...
lns3 = ax2.bar(mdates.date2num(list(FufData.index)), FufData['Rain_Obs'], 
        align = 'center', label = 'FUF Precipitation [mm]', width = 2)
...
ax1.legend(lns, labs, loc=2, frameon=False)





plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FufSWC_2007_v3.pdf", 
            bbox_inches='tight', pad_inches = 0.1)
