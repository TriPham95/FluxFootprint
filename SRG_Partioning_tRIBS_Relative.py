...
SrgParition['ET'] = SrgParition['Transpiration'] + SrgParition['Wet Canopy Evaporation'] + SrgParition['Soil Evaporation']


SrgParition['SE/ET'] = SrgParition['Soil Evaporation'] / SrgParition['ET']
SrgParition['WCE/ET'] = SrgParition['Wet Canopy Evaporation'] / SrgParition['ET']
SrgParition['T/ET'] = SrgParition['Transpiration'] / SrgParition['ET']



barWidth = 1
bars = np.add(SrgParition['SE/ET'], SrgParition['T/ET']).tolist()
...
lns2 = ax1.bar(SrgParition.index, SrgParition['SE/ET'], label = 'Esoil/ET',
               color='orange', width=barWidth, edgecolor = 'black',align = 'center')
lns3 = ax1.bar(SrgParition.index, SrgParition['T/ET'], 
               bottom=SrgParition['SE/ET'],  label = 'T/ET',
               color='green', width=barWidth, edgecolor = 'black', align = 'center')
lns4 = ax1.bar(SrgParition.index, SrgParition['WCE/ET'], 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/SrgPartition_Relative_2010_v2.pdf", 
