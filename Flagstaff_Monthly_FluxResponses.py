...
###
FufDF.groupby(['month']).mean()['NETRAD'].plot(ax=ax1, linewidth = 4, color = 'green')
FwfDF.groupby(['month']).mean()['NETRAD'].plot(ax=ax1, linewidth = 4, color = 'red')
FmfDF.groupby(['month']).mean()['NETRAD'].plot(ax=ax1, linewidth = 4, color = 'blue')
...
FufDF.groupby(['month']).mean()['LE'].plot(ax=ax2, linewidth = 4, color = 'green')
FwfDF.groupby(['month']).mean()['LE'].plot(ax=ax2, linewidth = 4, color = 'red')
FmfDF.groupby(['month']).mean()['LE'].plot(ax=ax2, linewidth = 4, color = 'blue')
...
FufDF.groupby(['month']).mean()['H'].plot(ax=ax3, linewidth = 4, color = 'green')
FwfDF.groupby(['month']).mean()['H'].plot(ax=ax3, linewidth = 4, color = 'red')
FmfDF.groupby(['month']).mean()['H'].plot(ax=ax3, linewidth = 4, color = 'blue')
...
FufDF.groupby(['month']).mean()['G_1_1_1'].plot(ax=ax4, linewidth = 4, color = 'green')
FwfDF.groupby(['month']).mean()['G'].plot(ax=ax4, linewidth = 4, color = 'red')
FmfDF.groupby(['month']).mean()['G'].plot(ax=ax4, linewidth = 4, color = 'blue')
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/Flagstaff_Monthly_SurfaceFluxes.pdf", 
