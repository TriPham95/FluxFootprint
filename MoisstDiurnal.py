...
Start = np.where(MoisstData["Date"] == str('06/01/2016 00:00'))[0][0]
End = np.where(MoisstData["Date"] == str('08/01/2016 01:00'))[0][0]
...
ax6.set_ylim((0, 1))
ax6.set_ylim((41, 0))
MoisstData['Rain_Obs'].plot(ax=ax6, linewidth = 2, color = 'black')
ax6.set_ylabel("P [mm]", fontsize = 22, fontweight = 'bold')
ax6.minorticks_off()
ax6.get_xaxis().set_visible(False)
#ax6.legend(labels = "Precipitation")

MoisstData['NetRad_Sim'][Start:End].plot(ax=ax4, color = 'red', linewidth = 2)
MoisstData['NetRad_Obs'][Start:End].plot(ax=ax4, color = 'black', linewidth = 2)
...
MoisstData['LE_Sim'][Start:End].plot(ax=ax1, color = 'red', linewidth = 2)
MoisstData['LE_Obs'][Start:End].plot(ax=ax1, color = 'black', linewidth = 2)
...
MoisstData['H_Sim'][Start:End].plot(ax=ax2, color = 'red', linewidth = 2)
MoisstData['H_Obs'][Start:End].plot(ax=ax2, color = 'black', linewidth = 2)
...
MoisstData['G_Sim'][Start:End].plot(ax=ax3, color = 'red', linewidth = 2)
MoisstData['G_Obs'][Start:End].plot(ax=ax3, color = 'black', linewidth = 2)
...
ax5.plot(mdates.date2num(list(MoisstData.index[Start:End])), MoisstData['TS_Sim'][Start:End], color = 'red', linewidth = 2)
ax5.plot(mdates.date2num(list(MoisstData.index[Start:End])), MoisstData['TS_Obs'][Start:End], color = 'black', linewidth = 2)
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/MoisstDiurnal_2016_v3.pdf", 
...
lns1 = ax1.plot(mdates.date2num(list(MoisstData.index)), MoisstData['SoilMoisture_Sim'],
         label = 'Simulated SWC', linewidth = 4, color = 'red')

lns2 = ax1.plot(mdates.date2num(list(MoisstData.index)), MoisstData['SoilMoisture_Obs'],
...
lns3 = ax2.bar(mdates.date2num(list(MoisstData.index)), MoisstData['Rain_Obs'], 
        align = 'center', label = 'MOISST Precipitation [mm]', width = 2)
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/MoisstSWC_2016_v3.pdf", 
            bbox_inches='tight', pad_inches = 0.1)
