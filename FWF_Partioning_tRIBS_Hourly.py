...
Start = FwfDF.index.get_loc((FwfDF[FwfDF.index == '2007-06-01 00:00:00']).iloc[0].name)
End = FwfDF.index.get_loc((FwfDF[FwfDF.index == '2007-09-01 00:00:00']).iloc[0].name)


FwfDF = FwfDF[Start:(End+1)]


FwfParition = FwfDF[['Transpiration', 'EvaporationCanopy',
...
lns2 = ax1.plot(FwfParition.index, FwfParition['Soil Evaporation'], 
               label = 'Soil Evaporation [mm/hr]', color='orange', linewidth = 4)
lns3 = ax1.plot(FwfParition.index, FwfParition['Transpiration'],  
               label = 'Transpiration [mm/hr]', color='green', linewidth = 4)
lns4 = ax1.plot(FwfParition.index, FwfParition['Wet Canopy Evaporation'], 
               color='blue',  label = 'Wet Canopy Evaporation [mm/hr]', linewidth = 4)

lns1 = ax2.bar(FwfParition.index, FwfParition['P_sum'], edgecolor = 'black', 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FwfPartition_Hourly_2007_v2.pdf", 
