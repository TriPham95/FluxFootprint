...
FwfFile = '/home/tpham/Desktop/ProcessedFiles/FwfDiurnal_validation_v3.csv'
...
Start = np.where(FwfData["Date"] == str('06/01/2008 00:00'))[0][0]
End = np.where(FwfData["Date"] == str('08/01/2008 01:00'))[0][0]
...
ax6.set_ylim((0, 1))
ax6.set_ylim((21, 0))
FwfData['Rain_Obs'].plot(ax=ax6, linewidth = 2, color = 'black')
ax6.set_ylabel("P [mm]", fontsize = 22, fontweight = 'bold')
ax6.minorticks_off()
ax6.get_xaxis().set_visible(False)
#ax6.legend(labels = "Precipitation")

FwfData['NetRad_Sim'][Start:End].plot(ax=ax4, color = 'red', linewidth = 2)
FwfData['NetRad_Obs'][Start:End].plot(ax=ax4, color = 'black', linewidth = 2)
...
FwfData['LE_Sim'][Start:End].plot(ax=ax1, color = 'red', linewidth = 2)
FwfData['LE_Obs'][Start:End].plot(ax=ax1, color = 'black', linewidth = 2)
...
FwfData['H_Sim'][Start:End].plot(ax=ax2, color = 'red', linewidth = 2)
FwfData['H_Obs'][Start:End].plot(ax=ax2, color = 'black', linewidth = 2)
...
FwfData['G_Sim'][Start:End].plot(ax=ax3, color = 'red', linewidth = 2)
FwfData['G_Obs'][Start:End].plot(ax=ax3, color = 'black', linewidth = 2)
...
ax5.plot(mdates.date2num(list(FwfData.index[Start:End])), FwfData['TS_Sim'][Start:End], color = 'red', linewidth = 2)
ax5.plot(mdates.date2num(list(FwfData.index[Start:End])), FwfData['TS_Obs'][Start:End], color = 'black', linewidth = 2)
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FwfDiurnal_2008_v3.pdf", 
...
lns1 = ax1.plot(mdates.date2num(list(FwfData.index)), FwfData['SoilMoisture_Sim'],
         label = 'Simulated SWC', linewidth = 4, color = 'red')

lns2 = ax1.plot(mdates.date2num(list(FwfData.index)), FwfData['SoilMoisture_Obs'],
...
lns3 = ax2.bar(mdates.date2num(list(FwfData.index)), FwfData['Rain_Obs'], 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FwfSWC_2008_v3.pdf", 
            bbox_inches='tight', pad_inches = 0.1)
