...
barWidth = 1
bars = np.add(SrcParition['Soil Evaporation'], SrcParition['Transpiration']).tolist()
...
lns2 = ax1.bar(SrcParition.index, SrcParition['Soil Evaporation'], label = 'Soil Evaporation [mm/month]',
               color='orange', width=barWidth, edgecolor = 'black',align = 'center')
lns3 = ax1.bar(SrcParition.index, SrcParition['Transpiration'], 
               bottom=SrcParition['Soil Evaporation'],  label = 'Transpiration [mm/month]',
               color='green', width=barWidth, edgecolor = 'black', align = 'center')
lns4 = ax1.bar(SrcParition.index, SrcParition['Wet Canopy Evaporation'], 
...
ax1.set_ylim((0, 150))
ax1.minorticks_off()
ax1.yaxis.set_ticks(np.arange(0, 71, 10))
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/SrcPartition_2010_v2.pdf", 
