...
PHI <-  31.9083 # Latitude of Flagstaff, AZ
...
FFP_2008_Src <- calc_footprint_FFP_climatology(zm = zm,
                                           z0 = z0_2008,
                                           umean = umean_2008,
                                           h = h_2008,
                                           ol = ol_2008,
...
options(scipen = 0)
image.plot(FFP_2008_Src$x_2d[1,],
           FFP_2008_Src$y_2d[,1],
           FFP_2008_Src$fclim_2d,
           xlim = c(-100,100),
           ylim = c(-100,100),
           xlab = "x Distance (m)",
           ylab = "y Distance (m)",
...
for (i in 1:8) lines(FFP_2008_Src$xr[[i]], 
                     FFP_2008_Src$yr[[i]], 
                     type="l", 
                     col="red")
