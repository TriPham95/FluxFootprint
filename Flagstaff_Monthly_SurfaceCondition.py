...
FufDF.groupby(['month']).mean()['P_sum'].plot(ax=ax1, linewidth = 4, color = 'green')
FwfDF.groupby(['month']).mean()['P_sum'].plot(ax=ax1, linewidth = 4, color = 'red')
FmfDF.groupby(['month']).mean()['P_sum'].plot(ax=ax1, linewidth = 4, color = 'blue')
...
LAIDF_AZ.groupby(['month']).mean()['FufLAI '].plot(ax=ax2, linewidth = 4, color = 'green')
LAIDF_AZ.groupby(['month']).mean()['FwfLAI '].plot(ax=ax2, linewidth = 4, color = 'red')
LAIDF_AZ.groupby(['month']).mean()['FmfLAI '].plot(ax=ax2, linewidth = 4, color = 'blue')
...
ALDF_AZ.groupby(['month']).mean()['FufAL '].plot(ax=ax3, linewidth = 4, color = 'green')
ALDF_AZ.groupby(['month']).mean()['FwfAL '].plot(ax=ax3, linewidth = 4, color = 'red')
ALDF_AZ.groupby(['month']).mean()['FmfAL '].plot(ax=ax3, linewidth = 4, color = 'blue')
...
NDVIDF_AZ.groupby(['month']).mean()['FufNDVI'].plot(ax=ax4, linewidth = 4, color = 'green')
NDVIDF_AZ.groupby(['month']).mean()['FwfNDVI'].plot(ax=ax4, linewidth = 4, color = 'red')
NDVIDF_AZ.groupby(['month']).mean()['FmfNDVI'].plot(ax=ax4, linewidth = 4, color = 'blue')
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/Flagstaff_Monthly_SurfaceCondition.pdf", 
