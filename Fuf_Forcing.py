...
Start = FufData.index.get_loc((FufData[FufData['TIMESTAMP_START'] == 200601010000]).iloc[0].name)
End = FufData.index.get_loc((FufData[FufData['TIMESTAMP_START'] == 200701010000]).iloc[0].name)
FufDF = FufData[Start:End]
...
FufData['P'].plot(ax=ax6,label = "Precipitation", color = 'black')
...
FufData['SW_IN'][Start:End].plot(ax=ax1, label = "Shortwave Radiation", color = 'black')
...
FufData['TA'][Start:End].plot(ax=ax2, label = "Air Temperature", color = 'black')
...
FufData['WS'][Start:End].plot(ax=ax3, label = "Wind Speed", color = 'black')
...
(FufData['PA']*10)[Start:End].plot(ax=ax4, label = "Air Pressure", color = 'black')
...
FufData['RH'][Start:End].plot(ax=ax5, label = "Relative Humidity", color = 'black')
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures/Fuf_Forcing_2006_v2.png", 
