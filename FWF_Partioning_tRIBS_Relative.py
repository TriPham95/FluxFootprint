...
FwfParition['ET'] = FwfParition['Transpiration'] + FwfParition['Wet Canopy Evaporation'] + FwfParition['Soil Evaporation']


FwfParition['SE/ET'] = FwfParition['Soil Evaporation'] / FwfParition['ET']
FwfParition['WCE/ET'] = FwfParition['Wet Canopy Evaporation'] / FwfParition['ET']
FwfParition['T/ET'] = FwfParition['Transpiration'] / FwfParition['ET']



barWidth = 1
bars = np.add(FwfParition['SE/ET'], FwfParition['T/ET']).tolist()
...
lns2 = ax1.bar(FwfParition.index, FwfParition['SE/ET'], label = 'Esoil/ET',
               color='orange', width=barWidth, edgecolor = 'black',align = 'center')
lns3 = ax1.bar(FwfParition.index, FwfParition['T/ET'], 
               bottom=FwfParition['SE/ET'],  label = 'T/ET',
               color='green', width=barWidth, edgecolor = 'black', align = 'center')
lns4 = ax1.bar(FwfParition.index, FwfParition['WCE/ET'], 
               bottom=bars, color='blue',  label = 'WCE/ET',
               width=barWidth, edgecolor = 'black', align = 'center')

lns1 = ax2.bar(FwfParition.index, FwfParition['P'], edgecolor = 'black', 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/FwfPartition_Relative_2007_v2.pdf", 
