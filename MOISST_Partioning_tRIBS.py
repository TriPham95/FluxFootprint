...
barWidth = 1
bars = np.add(MoisstParition['Soil Evaporation'], MoisstParition['Transpiration']).tolist()
...
lns2 = ax1.bar(MoisstParition.index, MoisstParition['Soil Evaporation'], label = 'Soil Evaporation [mm/month]',
               color='orange', width=barWidth, edgecolor = 'black',align = 'center')
lns3 = ax1.bar(MoisstParition.index, MoisstParition['Transpiration'], 
               bottom=MoisstParition['Soil Evaporation'],  label = 'Transpiration [mm/month]',
               color='green', width=barWidth, edgecolor = 'black', align = 'center')
lns4 = ax1.bar(MoisstParition.index, MoisstParition['Wet Canopy Evaporation'], 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/MoisstPartition_2016_v2.pdf", 
