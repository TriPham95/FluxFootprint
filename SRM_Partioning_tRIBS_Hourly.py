...
Start = SrmDF.index.get_loc((SrmDF[SrmDF.index == '2010-06-01 00:00:00']).iloc[0].name)
End = SrmDF.index.get_loc((SrmDF[SrmDF.index == '2010-09-01 00:00:00']).iloc[0].name)


SrmDF = SrmDF[Start:(End+1)]


SrmParition = SrmDF[['Transpiration', 'EvaporationCanopy',
...
lns2 = ax1.plot(SrmParition.index, SrmParition['Soil Evaporation'], 
               label = 'Soil Evaporation [mm/hr]', color='orange', linewidth = 4)
lns3 = ax1.plot(SrmParition.index, SrmParition['Transpiration'],  
               label = 'Transpiration [mm/hr]', color='green', linewidth = 4)
lns4 = ax1.plot(SrmParition.index, SrmParition['Wet Canopy Evaporation'], 
               color='blue',  label = 'Wet Canopy Evaporation [mm/hr]', linewidth = 4)

lns1 = ax2.bar(SrmParition.index, SrmParition['P_sum'], edgecolor = 'black', 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/SrmPartition_Hourly_2010_v2.pdf", 
