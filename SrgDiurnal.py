...
Start = np.where(SrgData["Date"] == str('06/01/2010 00:00'))[0][0]
End = np.where(SrgData["Date"] == str('08/01/2010 01:00'))[0][0]
...
ax6.set_ylim((0, 1))
ax6.set_ylim((15, 0))
SrgData['Rain_Obs'].plot(ax=ax6, linewidth = 2, color = 'black')
ax6.set_ylabel("P [mm]", fontsize = 22, fontweight = 'bold')
ax6.minorticks_off()
ax6.get_xaxis().set_visible(False)
#ax6.legend(labels = "Precipitation")

SrgData['NetRad_Sim'][Start:End].plot(ax=ax4, color = 'red', linewidth = 2)
SrgData['NetRad_Obs'][Start:End].plot(ax=ax4, color = 'black', linewidth = 2)
...
SrgData['LE_Sim'][Start:End].plot(ax=ax1, color = 'red', linewidth = 2)
SrgData['LE_Obs'][Start:End].plot(ax=ax1, color = 'black', linewidth = 2)
...
SrgData['H_Sim'][Start:End].plot(ax=ax2, color = 'red', linewidth = 2)
SrgData['H_Obs'][Start:End].plot(ax=ax2, color = 'black', linewidth = 2)
...
SrgData['G_Sim'][Start:End].plot(ax=ax3, color = 'red', linewidth = 2)
SrgData['G_Obs'][Start:End].plot(ax=ax3, color = 'black', linewidth = 2)
...
ax5.plot(mdates.date2num(list(SrgData.index[Start:End])), SrgData['TS_Sim'][Start:End], color = 'red', linewidth = 2)
ax5.plot(mdates.date2num(list(SrgData.index[Start:End])), SrgData['TS_Obs'][Start:End], color = 'black', linewidth = 2)
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/SrgDiurnal_2010_v3.pdf", 
...
lns1 = ax1.plot(mdates.date2num(list(SrgData.index)), SrgData['SoilMoisture_Sim'],
         label = 'Simulated SWC', linewidth = 4, color = 'red')

lns2 = ax1.plot(mdates.date2num(list(SrgData.index)), SrgData['SoilMoisture_Obs'],
...
lns3 = ax2.bar(mdates.date2num(list(SrgData.index)), SrgData['Rain_Obs'], 
...
plt.savefig("/home/tpham/Windows Share/Thesis_Figures_2/SrgSWC_2010_v3.pdf", 
            bbox_inches='tight', pad_inches = 0.1)
